...
## Layout
Each game will be first built in a playable way in a Rust crate. Then there will be a separate crate that can be used to solve a puzzle given an input. There will also be a web crate that allows interaction with other crates in the browser
